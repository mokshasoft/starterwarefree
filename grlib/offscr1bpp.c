...
//*****************************************************************************
static void
GrOffScreen1BPPPixelDraw(void *pvDisplayData, int lX, int lY,
...
//*****************************************************************************
static void
GrOffScreen1BPPPixelDrawMultiple(void *pvDisplayData, int lX, int lY,
...
//*****************************************************************************
static void
GrOffScreen1BPPLineDrawH(void *pvDisplayData, int lX1, int lX2, int lY,
                         unsigned int ulValue)
{
    int lBytesPerRow, lMask;
    unsigned char *pucData;
    ...
    //
    // Copy the pixel value into all 32 pixels of the unsigned int.  This will
    ...
    //
    if(((unsigned int)pucData & 1) && ((lX2 - lX1) > 6))
    {
        //
    ...
    //
    if(((unsigned int)pucData & 2) && ((lX2 - lX1) > 14))
    {
        //
...
//*****************************************************************************
static void
GrOffScreen1BPPLineDrawV(void *pvDisplayData, int lX, int lY1, int lY2,
                         unsigned int ulValue)
{
    unsigned char *pucData;
    int lBytesPerRow;
                        ...
                        unsigned int ulValue)
{
    ...
    //
    if(((unsigned int)pucData & 1) && ((pRect->sXMax - lX) > 6))
    {
        //
    ...
    //
    if(((unsigned int)pucData & 2) && ((pRect->sXMax - lX) > 14))
    {
        //
...
//*****************************************************************************
static unsigned int
GrOffScreen1BPPColorTranslate(void *pvDisplayData, unsigned int ulValue)
{
    //
    // Check the arguments.
    //
...
//*****************************************************************************
void
GrOffScreen1BPPInit(tDisplay *pDisplay, unsigned char *pucImage, int lWidth,
                    int lHeight)
{
    //
    // Check the arguments.
