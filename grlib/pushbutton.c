...
RectangularButtonPaint(tWidget *pWidget)
{
    ...
    if(pPush->ulStyle & (PB_STYLE_TEXT | PB_STYLE_IMG))
    {
        ...
        if(pPush->ulStyle & PB_STYLE_IMG)
        {
            ...
            //
            GrImageDraw(&sCtx, pucImage, pWidget->sPosition.sXMin, pWidget->sPosition.sYMin);
        }
...
//*****************************************************************************
static int
RectangularButtonClick(tWidget *pWidget, unsigned int ulMsg, int lX, int lY)
{
    tPushButtonWidget *pPush;
...
//*****************************************************************************
int
RectangularButtonMsgProc(tWidget *pWidget, unsigned int ulMsg,
...
//*****************************************************************************
static int
CircularButtonClick(tWidget *pWidget, unsigned int ulMsg, int lX, int lY)
{
    tPushButtonWidget *pPush;
    int lXc, lYc, lR;
...
//*****************************************************************************
int
CircularButtonMsgProc(tWidget *pWidget, unsigned int ulMsg,
                      unsigned int ulParam1, unsigned int ulParam2)
{
    //
    // Check the arguments.
