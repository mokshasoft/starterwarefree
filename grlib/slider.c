...
//*****************************************************************************
static short
SliderValueToPosition(tSliderWidget *pSlider, int lValue)
{
...
SliderPositionToValue(tSliderWidget *pSlider, short sPos)
{
    ...
    //
    lValue = ((int)sPos * ((pSlider->lMax - pSlider->lMin) + 1)) /
             (int)((sMax - sMin) + 1);
...
//*****************************************************************************
static int
SliderClick(tWidget *pWidget, unsigned int ulMsg, int lX, int lY)
{
    tSliderWidget *pSlider;
...
//*****************************************************************************
int
SliderMsgProc(tWidget *pWidget, unsigned int ulMsg,
...
//*****************************************************************************
void
SliderInit(tSliderWidget *pWidget, const tDisplay *pDisplay, int lX, int lY,
