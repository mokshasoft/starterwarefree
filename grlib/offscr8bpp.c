...
//*****************************************************************************
static unsigned int
GrOffScreen8BPPColorTranslate(void *pvDisplayData, unsigned int ulValue)
{
...
//*****************************************************************************
static void
GrOffScreen8BPPPixelDraw(void *pvDisplayData, int lX, int lY,
...
//*****************************************************************************
static void
GrOffScreen8BPPPixelDrawMultiple(void *pvDisplayData, int lX, int lY,
        ...
        case 1:
        {
            ...
            while(lCount)
            {
                ...
                for(; (lX0 < 8) && lCount; lX0++, lCount--)
                {
                    ...
                    //
                    *pucPtr++ = (((unsigned int *)pucPalette)[(ulByte >>
                                                                (7 - lX0)) &
                                                               1]);
                }
...
//*****************************************************************************
static void
GrOffScreen8BPPLineDrawH(void *pvDisplayData, int lX1, int lX2, int lY,
                         unsigned int ulValue)
{
    unsigned char *pucData;
    ...
    //
    // Copy the pixel value into all 4 pixels of the unsigned int.  This will
...
//*****************************************************************************
static void
GrOffScreen8BPPLineDrawV(void *pvDisplayData, int lX, int lY1, int lY2,
                         unsigned int ulValue)
{
    unsigned char *pucData;
    int lBytesPerRow;
...
//*****************************************************************************
void
GrOffScreen8BPPInit(tDisplay *pDisplay, unsigned char *pucImage, int lWidth,
                    int lHeight)
{
    //
    // Check the arguments.
...
//*****************************************************************************
void
GrOffScreen8BPPPaletteSet(tDisplay *pDisplay, unsigned int *pulPalette,
