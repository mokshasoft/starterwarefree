...
//*****************************************************************************
static unsigned int
GrOffScreen4BPPColorTranslate(void *pvDisplayData, unsigned int ulValue)
{
    unsigned int ulIdx, ulDiff, ulMatchIdx, ulMatchDiff, ulR, ulG, ulB;
...
//*****************************************************************************
static void
GrOffScreen4BPPPixelDraw(void *pvDisplayData, int lX, int lY,
...
//*****************************************************************************
static void
GrOffScreen4BPPPixelDrawMultiple(void *pvDisplayData, int lX, int lY,
...
//*****************************************************************************
static void
GrOffScreen4BPPLineDrawH(void *pvDisplayData, int lX1, int lX2, int lY,
                         unsigned int ulValue)
{
    unsigned char *pucData;
    int lBytesPerRow;
    ...
    //
    // Copy the pixel value into all 8 pixels of the unsigned int.  This will
    ...
    //
    if(((unsigned int)pucData & 1) && ((lX2 - lX1) > 0))
    {
        //
    ...
    //
    if(((unsigned int)pucData & 2) && ((lX2 - lX1) > 2))
    {
        //
...
//*****************************************************************************
static void
GrOffScreen4BPPLineDrawV(void *pvDisplayData, int lX, int lY1, int lY2,
                         unsigned int ulValue)
{
    unsigned char *pucData;
    int lBytesPerRow;
                        ...
                        unsigned int ulValue)
{
    ...
    //
    if(((unsigned int)pucData & 1) && (pRect->sXMax - lX) > 0)
    {
        //
    ...
    //
    if(((unsigned int)pucData & 2) && ((pRect->sXMax - lX) > 2))
    {
        //
...
//*****************************************************************************
void
GrOffScreen4BPPInit(tDisplay *pDisplay, unsigned char *pucImage, int lWidth,
                    int lHeight)
{
    //
    // Check the arguments.
...
//*****************************************************************************
void
GrOffScreen4BPPPaletteSet(tDisplay *pDisplay, unsigned int *pulPalette,
                          unsigned int ulOffset, unsigned int ulCount)
{
    unsigned char *pucData;
