...
ScheduleNextTransmission(const tUSBBuffer *psBuffer)
{
    ...
    unsigned int ulPacket, ulSpace, ulTotal;
...
//*****************************************************************************
static unsigned int
HandleRxAvailable(tUSBBuffer *psBuffer, unsigned int ulSize,
                  unsigned char *pucData)
{
    tUSBBufferVars *psVars;
    unsigned int ulAvail, ulRead, ulPacket, ulRetCount;
...
{
    unsigned int ulBufData, ulClientData;
    tUSBBufferVars *psVars;
...
//*****************************************************************************
static unsigned int
HandleTxComplete(tUSBBuffer *psBuffer, unsigned int ulSize)
{
    tUSBBufferVars *psVars;
...
//*****************************************************************************
static unsigned int
HandleRequestBuffer(tUSBBuffer *psBuffer, unsigned int ulSize,
...
//! is to be buffered.  This structure must remain accessible for as int as
...
//*****************************************************************************
void
USBBufferDataWritten(const tUSBBuffer *psBuffer, unsigned int ulLength)
{
    tUSBBufferVars *psVars;
...
//*****************************************************************************
void
USBBufferDataRemoved(const tUSBBuffer *psBuffer, unsigned int ulLength)
{
    tUSBBufferVars *psVars;
...
//*****************************************************************************
unsigned int
USBBufferEventCallback(void *pvCBData, unsigned int ulEvent,
