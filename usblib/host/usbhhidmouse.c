...
//
//*****************************************************************************
static unsigned int USBHMouseCallback(void *pvCBData,
...
//*****************************************************************************
unsigned int
USBHMouseOpen(unsigned int ulIndex, tUSBCallback pfnCallback,
...
//*****************************************************************************
unsigned int
USBHMouseClose(unsigned int ulInstance)
{
...
//*****************************************************************************
unsigned int
USBHMouseInit(unsigned int ulInstance)
{
    tUSBHMouse *pUSBHMouse;
    tHIDInstance *pHIDIntance;

    pHIDIntance = (tHIDInstance *)ulInstance;

    //
    // Recover the pointer to the instance data.
    //
    pUSBHMouse = (tUSBHMouse *)pHIDIntance->ulCBData;
...
UpdateMouseState(tUSBHMouse *pUSBHMouse)
{
    ...
    if(pUSBHMouse->pucBuffer[1] != 0)
    {
        ...
        pUSBHMouse->pfnCallback(0,
                                USBH_EVENT_HID_MS_X,
                                (unsigned int)pUSBHMouse->pucBuffer[1],
                                0);
    }
    if(pUSBHMouse->pucBuffer[2] != 0)
    {
        ...
        pUSBHMouse->pfnCallback(0,
                                USBH_EVENT_HID_MS_Y,
                                (unsigned int)pUSBHMouse->pucBuffer[2],
                                0);
    }
}
...
//*****************************************************************************
unsigned int
USBHMouseCallback(void *pvCBData, unsigned int ulEvent,
