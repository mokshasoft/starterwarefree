...
//
//*****************************************************************************
static unsigned int HIDMouseRxHandler(void *pvCBData,
                                          unsigned int ulEvent,
                                          unsigned int ulMsgData,
                                          void *pvMsgData);
static unsigned int HIDMouseTxHandler(void *pvCBData,
                                          unsigned int ulEvent,
                                          unsigned int ulMsgData,
                                          void *pvMsgData);
...
//*****************************************************************************
static unsigned int
HIDMouseRxHandler(void *pvCBData, unsigned int ulEvent,
...
//*****************************************************************************
static unsigned int
HIDMouseTxHandler(void *pvCBData, unsigned int ulEvent,
                  unsigned int ulMsgData, void *pvMsgData)
{
    tHIDMouseInstance *psInst;
    tUSBDHIDMouseDevice *psDevice;
...
//*****************************************************************************
void *
USBDHIDMouseInit(unsigned int ulIndex, const tUSBDHIDMouseDevice *psDevice)
{
    void *pvRetcode;
...
//*****************************************************************************
void *
USBDHIDMouseCompositeInit(unsigned int ulIndex,
