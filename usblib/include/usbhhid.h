...
//
//*****************************************************************************
extern unsigned int USBHHIDOpen(unsigned int ulIndex,
                                 tHIDSubClassProtocol eDeviceType,
                                 tUSBCallback pfnCallback,
                                 unsigned int ulCBData);
extern void USBHHIDClose(unsigned int ulInstance);
extern unsigned int USBHHIDGetReportDescriptor(unsigned int ulInstance,
                                                unsigned char *pucBuffer,
                                                unsigned int ulSize);
extern unsigned int USBHHIDSetIdle(unsigned int ulInstance,
                                    unsigned char ucDuration,
                                    unsigned char ucReportID);
extern unsigned int USBHHIDSetProtocol(unsigned int ulInstance,
                                        unsigned int ulBootProtocol);
extern unsigned int USBHHIDSetReport(unsigned int ulInstance,
                                      unsigned int ulInterface,
                                      unsigned char *pucData,
                                      unsigned int ulSize);
extern unsigned int USBHHIDGetReport(unsigned int ulInstance,
                                      unsigned int ulInterface,
                                      unsigned char *pucData,
                                      unsigned int ulSize);
