...
#define USB_HID_INPUT_NONVOLATILE 0x0000
#define USB_HID_INPUT_VOLATILE 0x0080
#define USB_HID_INPUT_BITF      0x0000
#define USB_HID_INPUT_BYTES     0x0100
...
#define USB_HID_FEATURE_NONVOLATILE 0x0000
#define USB_HID_FEATURE_VOLATILE 0x0080
#define USB_HID_FEATURE_BITF    0x0000
#define USB_HID_FEATURE_BYTES   0x0100
...
#define USB_HID_OUTPUT_NONVOLATILE 0x0000
#define USB_HID_OUTPUT_VOLATILE 0x0080
#define USB_HID_OUTPUT_BITF     0x0000
#define USB_HID_OUTPUT_BYTES    0x0100
...
#define USBH_HID_CAPS_ARRAY_SZ  (USBH_HID_MAX_USAGE/sizeof(unsigned int))
...
typedef struct
{
    ...
    //! key.
    //
    unsigned int pulCapsLock[USBH_HID_CAPS_ARRAY_SZ];
