...
//
//*****************************************************************************
extern void * USBDCDCCompositeInit(unsigned int ulIndex,
                                   const tUSBDCDCDevice *psCDCDevice);
extern void *USBDCDCInit(unsigned int ulIndex,
                         const tUSBDCDCDevice *psCDCDevice);
...
extern unsigned int USBDCDCPacketWrite(void *pvInstance,
                                        unsigned char *pcData,
                                        unsigned int ulLength,
                                        tBoolean bLast);
extern unsigned int USBDCDCPacketRead(void *pvInstance,
                                       unsigned char *pcData,
                                       unsigned int ulLength,
                                       tBoolean bLast);
extern unsigned int USBDCDCTxPacketAvailable(void *pvInstance);
extern unsigned int USBDCDCRxPacketAvailable(void *pvInstance);
