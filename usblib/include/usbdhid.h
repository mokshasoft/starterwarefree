...
typedef struct
{
    ...
    //
    unsigned int ulTimeSinceReportmS;
}
tHIDReportIdle;
...
//! standard "unsigned int" return type for the callback).
//
//*****************************************************************************
...
//
//*****************************************************************************
extern void *USBDHIDInit(unsigned int ulIndex,
                         const tUSBDHIDDevice *psHIDDevice);
extern void *USBDHIDCompositeInit(unsigned int ulIndex,
...
extern unsigned int USBDHIDReportWrite(void *pvInstance,
                                        unsigned char *pcData,
                                        unsigned int ulLength,
                                        tBoolean bLast);
extern unsigned int USBDHIDPacketRead(void *pvInstance,
                                       unsigned char *pcData,
                                       unsigned int ulLength,
                                       tBoolean bLast);
extern unsigned int USBDHIDTxPacketAvailable(void *pvInstance);
extern unsigned int USBDHIDRxPacketAvailable(void *pvInstance);
