 ...
 * \file  random.c
 *
 * \brief Random number generator utilizing MD4 hash function of
...
//
//*****************************************************************************
static unsigned int g_pulRandomEntropy[16];
...
//
//*****************************************************************************
static unsigned int g_ulRandomIndex = 0;
...
//
//*****************************************************************************
static unsigned int g_ulRandomSeed = 0;
...
//*****************************************************************************
void
RandomAddEntropy(unsigned int ulEntropy)
{
    //
...
RandomSeed(void)
{
    unsigned int ulA, ulB, ulC, ulD, ulTemp, ulIdx;
